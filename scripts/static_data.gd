...
@export var unit_stats = { 
	...
	Gameplay.UnitTypes.TOWER_NODE: { "name": "Anti-virus", "hp_max": 50, "ap_max": 9, "attack": 10, "attack_extra": 5, "attack_range": 2, "ap_cost_of_attack": 3 },
	
	Gameplay.UnitTypes.WORM: { "name": "Worm", "hp_max": 5, "ap_max": 3, "abilities": ["scale","self_modify_to_virus","self_modify_to_trojan"] },
	Gameplay.UnitTypes.TROJAN: { "name": "Trojan", "hp_max": 12, "ap_max": 8, "abilities": ["capture_tower","backdoor"] },
	Gameplay.UnitTypes.VIRUS: { "name": "Virus", "hp_max": 30, "ap_max": 5, "attack": 3, "attack_extra": 2, "ap_cost_of_attack": 3 },
	}
...
@export var ability_stats = {
	...
	"repair": { "name": "Repair", "target": Gameplay.TargetTypes.UNIT, "ap": 3, "cooldown": 0 },
